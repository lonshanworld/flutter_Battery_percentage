package com.example.training_8;
...
public class MainActivity extends FlutterActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        new MethodChannel(Objects.requireNonNull(getFlutterEngine()).getDartExecutor().getBinaryMessenger(),"course.flutter.dev/battery").setMethodCallHandler(
